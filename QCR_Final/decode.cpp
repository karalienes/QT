...
void Decode::decode(const Mat &scores, const Mat &geometry, float scoreThresh, vector<RotatedRect> &detections, vector<vector<RotatedRect> > &line_detections, vector<float> &confidences, vector<vector<float> > &box_confidences)
{
    detections.clear();
    confidences.clear();
